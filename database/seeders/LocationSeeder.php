...
class LocationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        // TODO: add address
        Location::create(([
            'name' => 'Ghostbumps Yogyakarta',
            'photo_path' => 'images//jogja_location.jpg',
        ...
        // TODO: add address
        Location::create(([
            'name' => 'Ghostbumps Surabaya',
            'photo_path' => 'images//surabaya_location.jpg',
            'address' => 'No. 20, Jalan P.B. Sudirman, Dauh Puri Kelod, Denpasar Barat, Denpasar, Bali, Indonesia',
        ...
        Location::create(([
            ...
            'photo_path' => 'images//denpasar_location.jpg',
            'address' => 'No. 20, Jalan P.B. Sudirman, Dauh Puri Kelod, Denpasar Barat, Denpasar, Bali, Indonesia',
