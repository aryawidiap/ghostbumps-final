...
function nextStep() {
    if (agreePolicy.value) {
        router.visit('/bookings/cancel/1234908/reason');
    }
}
</script>
                ...
                <div class="w-full px-4 py-10">
                    ...
                    <div class="bg-red-900 rounded-3xl overflow-hidden mb-6 md:flex shadow-lg p-6">
                        <div class="text-white">
                            <div class="mb-4">
                                <span class="font-bold">Event:</span> Ghostbumps De
                            </div>
                            <div class="mb-4">
                                <span class="font-bold">Date:</span> 14 April 2024
                            </div>
                            <div class="mb-4">
                                <span class="font-bold">Time:</span> 13:00 - 14:00
                            </div>
                        </div>
                    </div>
                    <div class="bg-red-800 p-6 rounded-lg">
                        ...
                        <button @click="nextStep" :disabled="!agreePolicy" class="mt-4 bg-white text-red-800 px-4 py-2 rounded">Continue</button>
                    </div>
                </div>
            </div>
        </div>
